...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	define("CENTINEL_PROCESSOR_ID", "your processor ID");
    define("CENTINEL_MERCHANT_ID", "your merchant ID");
	define("CENTINEL_TRANSACTION_PWD", "your transaction password");
	define("CENTINEL_MAPS_URL", "https://centineltest.cardinalcommerce.com/MAPS/txns.asp");


	define("CENTINEL_TERM_URL", "https://www.yourdomain.com/ccAuthenticate.php");
	

    // Check with Cardinal to determine appropriate Timeout period for this payment type
	define("CENTINEL_TIMEOUT_CONNECT","5000");
	define("CENTINEL_TIMEOUT_READ","35000");
	...
	define("CENTINEL_MERCHANT_LOGO",  "..".DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."images".DIRECTORY_SEPARATOR."merchant_logo.gif");
