...
<div id="system" class="<?php echo $this->params->get('pageclass_sfx')?>">
	...
	<form class="submission" action="<?php echo $this->action ?>" method="post" name="adminForm" onSubmit="setgood();">
		<fieldset>
			...
			<?php echo $this->editor->display('text', $this->article->text, '98%', '300', '70', '15'); ?>
