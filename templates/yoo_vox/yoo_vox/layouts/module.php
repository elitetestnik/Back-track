...
if ($style == '') {
	...
	if ($module->position == 'contenttop') { $style = 'rounded'; $color = 'white'; }
	if ($module->position == 'contentleft') { $style = 'rounded'; $color = 'white'; }
	if ($module->position == 'contentright') $style = 'rounded';
	if ($module->position == 'contentbottom') $style = 'rounded';
...
switch ($style) {
	...
	case 'rounded':
		$template  = '3-3-3_h';
		$style     = 'mod-'.$style;
		if (($color == '' || $color == 'grey') && ($module->position == 'top' || $module->position == 'topblock' || $module->position == 'bottom' || $module->position == 'bottomblock')) {
			$template = '3-1-3_h';
			$style     = 'mod-rounded-special '.$style;
		}
